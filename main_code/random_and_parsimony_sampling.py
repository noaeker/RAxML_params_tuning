        ...
        for n_random in n_random_grid:
            ...
            for i in range(n_sample_points):
                ...
                sampled_data_parsimony = data[data["tree_type"] == "parsimony"].groupby(
                    by=["msa_name", "run_name", "spr_radius", "spr_cutoff", "best_msa_ll"]).sample(n=n_parsimony, random_state=seed)

                sampled_data_random = data[data["tree_type"] == "random"].groupby(
                    by=["msa_name", "run_name", "spr_radius", "spr_cutoff", "best_msa_ll"]).sample(n=n_random, random_state=seed)
