...
def get_job_related_files_paths(curr_job_folder, job_ind):
    ...
    job_local_raxml_runs_path = os.path.join(curr_job_folder, "local_raxml_runs" + str(job_ind))
    general_log_path = os.path.join(curr_job_folder, "job_" + str(job_ind) + "_general_log.log")
    return {"job_status_file": job_status_file,  "job_local_raxml_runs_path": job_local_raxml_runs_path,
