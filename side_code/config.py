...
if not LOCAL_RUN:
    ...
    SAMPLING_MAIN_CODE_PATH = f"{PROJECT_ROOT_DIRECRTORY}/raw_data_sampling_analysis/random_and_parsimony_sampling.py"
    ...
    GENERAL_MSA_DIR = "/Users/noa/Workspace/data/New_MSAs/simulated_MSAs_only_GTR+G"#'/Users/noa/Workspace/data/new_MSAs/Selectome_msas'#"/Users/noa/Workspace/data/single-gene_alignments"
