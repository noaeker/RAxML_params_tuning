...
res.cox <- coxph(formula=Surv(normalized_relative_time, is_global_max) ~ (spr_radius+spr_cutoff+starting_tree_type)*feature_pypythia_msa_difficulty, data = train)
summary(res.cox)
```
...
bin_glm<-  glm(is_global_max ~ (spr_radius+spr_cutoff+starting_tree_type)*feature_pypythia_msa_difficulty, data = train, family = "binomial")
