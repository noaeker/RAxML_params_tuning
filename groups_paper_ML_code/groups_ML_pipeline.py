...
def get_full_and_MSA_features(results):
    ...
    full_features = [col for col in full_features if 'SVR' not in col and 'mds_1' not in col and 'mds_2' not in col and 'mds_3' not in col and 'svc_min_best_score' not in col and 'svc_mean_best_score' not in col ]
