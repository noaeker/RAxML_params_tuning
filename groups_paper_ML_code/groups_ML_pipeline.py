...
def get_full_and_MSA_features(results):
    ...
    full_features = general_MSA_columns+["n_total_trees_sampled"]+[col for col in full_features if
                                                                    'MSA_level__var' not in col and 'MSA_level__PCA' not in col and 'non_best_score' not in col ] #and 'svc_min_best_score' not in col and  'poly' not in col and 'lin' not in col and 'median' not in col and 'pct_25' not in col and 'pct_75' not in col and 'PCA3_n_components' not in col   and 'PCA2' not in col and 'PCA2' not in col and 'PCA4' not in col and 'PCA5' not in col and 'corr' not in col and not  'll_diff' in col and 'svc' not in col  and 'PCA3_best_trees_distance_to_final_trees' not in col and 'PCA3_best_trees_distance_to_best_trees' not in coland 'svc_min_best_score' not in col and  'poly' not in col and 'lin' not in col and 'median' not in col and 'pct_25' not in col and 'pct_75' not in col and 'PCA3_n_components' not in col   and 'PCA2' not in col and 'PCA2' not in col and 'PCA4' not in col and 'PCA5' not in col and 'corr' not in col and not  'll_diff' in col and 'svc' not in col  and 'PCA3_best_trees_distance_to_final_trees' not in col and 'PCA3_best_trees_distance_to_best_trees' not in col
