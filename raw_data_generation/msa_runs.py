...
def generate_all_msa_single_raxml_runs(msa_path, spr_radius_grid_str, spr_cutoff_grid_str,
    ...
    raxml_runs_list = {id:raxml_run for id, raxml_run in enumerate(msa_runs)}
    return  raxml_runs_list
